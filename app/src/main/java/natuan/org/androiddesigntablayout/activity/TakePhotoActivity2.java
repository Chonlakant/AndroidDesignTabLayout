...
import natuan.org.androiddesigntablayout.view.RevealBackgroundView;
    ...
    public class PhotoFiltersAdapter extends RecyclerView.Adapter<PhotoFiltersAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (mSelectItem == position) {
                holder.titleView.setTextColor(mContext.getResources().getColor(R.color.button_material_light));
            } else {
                holder.titleView.setTextColor(mContext.getResources().getColor(R.color.button_material_light));
            }
