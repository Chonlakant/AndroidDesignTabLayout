 ...
 *******************************************************************************/
package natuan.org.androiddesigntablayout.calendarstock;
...
import natuan.org.androiddesigntablayout.Utils2;
...
public class ColorPickerPreference extends Preference {
    ...
    protected void onClick() {
        ...
        ColorPickerDialog colorcalendar = (ColorPickerDialog) ColorPickerDialog.newInstance(R.string.color_picker_default_title,
				mColorChoices, getValue(), mNumColumns, Utils2.isTablet(getContext())? ColorPickerDialog.SIZE_LARGE : ColorPickerDialog.SIZE_SMALL);
