...
public class AdapterRecyclerViewFreeTwo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterRecyclerViewFreeTwo(List<Object> items, Context context) {
        this.items = items;
