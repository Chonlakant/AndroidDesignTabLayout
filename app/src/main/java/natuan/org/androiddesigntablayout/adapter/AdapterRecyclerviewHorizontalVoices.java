...
public class AdapterRecyclerviewHorizontalVoices extends RecyclerView.Adapter<AdapterRecyclerviewHorizontalVoices.ViewHolder> {
    ...
    public AdapterRecyclerviewHorizontalVoices(Context context, List<Posts> list) {
    ...
    public void SetVoicesOnItemClickListener(final OnItemClickListener mItemClickListener) {
