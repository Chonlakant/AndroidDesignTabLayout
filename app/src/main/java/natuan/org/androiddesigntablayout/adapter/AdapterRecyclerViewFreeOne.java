...
public class AdapterRecyclerViewFreeOne extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterRecyclerViewFreeOne(List<Object> items, Context context) {
        this.items = items;
