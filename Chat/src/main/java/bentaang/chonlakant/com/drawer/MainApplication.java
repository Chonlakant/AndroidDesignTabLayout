...
import bentaang.chonlakant.com.drawer.handler.ApiBus;
import bentaang.chonlakant.com.drawer.handler.ApiHandler;
import bentaang.chonlakant.com.drawer.handler.ApiService;
...
public class MainApplication extends Application  {
    ...
    public static final String ENDPOINT = "https://chat.vdomax.com:1314";
    ...
    public void onCreate() {
        ...
        thWrTishTypeface = (new TypefaceCollection.Builder()
                .set(Typeface.NORMAL, Typeface.createFromAsset(getAssets(), "fonts/th/Nophamas.ttf"))
                .create());
