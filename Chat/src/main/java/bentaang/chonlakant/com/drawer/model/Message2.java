...
public class Message2 {
	...
	public Message2(Integer type, Integer state, String fromUserName,
					String fromUserAvatar, String toUserName, String toUserAvatar,
					String content, String data, Boolean isSend, Boolean sendSuccess, Date time,String typeColor,String typeStyle,Bitmap mImage,float timeVoice,String filePath) {
		super();
		this.type = type;
		this.state = state;
